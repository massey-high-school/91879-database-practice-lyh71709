...
--
-- Host: localhost
-- Generation Time: Sep 03, 2020 at 06:39 PM
...
--
-- Table structure for table `2020_L1_Prac_HenLy`
--

CREATE TABLE IF NOT EXISTS `2020_L1_Prac_HenLy` (
...
--
-- Dumping data for table `2020_L1_Prac_HenLy`
--

INSERT INTO `2020_L1_Prac_HenLy` (`ID`, `Title`, `Author`, `Genre`, `Rating`, `Review`) VALUES
